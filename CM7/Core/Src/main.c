...
/* Definitions for Gear_detect */
osThreadId_t Gear_detectHandle;
const osThreadAttr_t Gear_detect_attributes = {
  .name = "Gear_detect",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
/* Definitions for gearStateQueue */
osMessageQueueId_t gearStateQueueHandle;
const osMessageQueueAttr_t gearStateQueue_attributes = {
  .name = "gearStateQueue"
};
/* USER CODE BEGIN PV */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : GEAR_UP_Pin */
  ...
  /*Configure GPIO pin : CLUTCH_DETECT_Pin */
...
/* USER CODE BEGIN Header_Start_Gear_detect */
/**
* @brief Function implementing the Gear_detect thread.
* @param argument: Not used
* @retval None
*/
...
void Start_Gear_detect(void *argument)
{
    static GearState gearState = Neutral;
    static GearState prevGearState = 255;
